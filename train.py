        ...
        for lr in lrs:
            for split in splits:
                ...
                args = {
                    ...
                    # 'model': get_model_conv(pretrain_out=4, outsize=5, path='<pretrain_ckpt_path>'),
                    'model': get_vani(outsize=5, dropout=0.25),
                    # 'model': get_model_oct_withpretrain(pretrain_out=4, outsize=5, path='<pretrain_ckpt_path>', dropout=0.15),
                    'save_path': './checkpoints/oct_vani/',
                    'bce_weight': 1,
                    'epochs': 200,
                    'lr': lr,
                    'batch_size': 300,
