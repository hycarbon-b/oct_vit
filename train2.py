        ...
        for lr in lrs:
            for split in splits:
                ...
                args = {
                    ...
                    'model': get_model_oct_withpretrain(pretrain_out=4,outsize=5, path='/code/covid_ckpts/oct4class_biglr/val_acc0.9759836196899414.pt', dropout=0.45),
                    'save_path': f'/code/covid_ckpts/randz-bal-all-2/', 
                    'bce_weight': 1,     
                    'epochs': 300, 
                    'lr': lr, 
                    'batch_size': 300, 
                    ...
                    'wandb': ['2065136374','randz-bal-all-2',run_name],
